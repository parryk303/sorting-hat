...
export default function Home() {
  ...
  const greatHall =
    "url(https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/hostedimages/1398089831i/9366155._SX540_.jpg)";
      ...
      >
        <Grid container spacing={3}>
          ...
          >
            <Typography
              variant="h4"
              sx={{ fontFamily: "MedievalSharp", marginLeft: "90px" }}
            >
              Imports
            </Typography>
            <TextField
          ...
          >
            <Typography
              variant="h4"
              sx={{ fontFamily: "MedievalSharp", marginLeft: "110px" }}
            >
              Icons
            </Typography>
            <TextField
          ...
          >
            <Typography
              variant="h4"
              sx={{ fontFamily: "MedievalSharp", marginLeft: "55px" }}
            >
              Components
            </Typography>
            <TextField
